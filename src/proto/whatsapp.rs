...
pub struct BotMetadata {
    ...
    pub search_metadata: ::core::option::Option<BotSearchMetadata>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct Conversation {
    ...
    pub contact_primary_identity_key: ::core::option::Option<
...
pub struct InteractiveAnnotation {
    ...
    #[prost(oneof = "interactive_annotation::Action", tags = "2, 3")]
...
pub struct MediaEntry {
    ...
    #[prost(string, optional, tag = "6")]
    pub server_media_type: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(bytes = "vec", optional, tag = "7")]
    pub upload_token: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(bytes = "vec", optional, tag = "8")]
    pub validated_timestamp: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(bytes = "vec", optional, tag = "9")]
    pub sidecar: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(string, optional, tag = "10")]
    pub object_id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "11")]
    pub fbid: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(message, optional, tag = "12")]
    pub downloadable_thumbnail: ::core::option::Option<
        media_entry::DownloadableThumbnail,
    >,
    #[prost(string, optional, tag = "13")]
    pub handle: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "14")]
    ...
    #[prost(message, optional, tag = "15")]
    pub progressive_jpeg_details: ::core::option::Option<
        media_entry::ProgressiveJpegDetails,
    >,
}
/// Nested message and enum types in `MediaEntry`.
pub mod media_entry {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct DownloadableThumbnail {
        #[prost(bytes = "vec", optional, tag = "1")]
        pub file_sha256: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
        #[prost(bytes = "vec", optional, tag = "2")]
        pub file_enc_sha256: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    ...
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct ProgressiveJpegDetails {
...
pub struct Message {
    ...
    >,
    #[prost(message, optional, tag = "10")]
    pub call: ::core::option::Option<message::Call>,
    #[prost(message, optional, tag = "11")]
...
pub mod message {
    ...
    pub struct BotFeedbackMessage {
        ...
        #[prost(
            enumeration = "bot_feedback_message::BotFeedbackKind",
            optional,
            tag = "2"
        )]
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "BOT_FEEDBACK_NEGATIVE_GENERIC" => {
                        Some(Self::BotFeedbackNegativeGeneric)
                    }
                    "BOT_FEEDBACK_NEGATIVE_HELPFUL" => {
                        Some(Self::BotFeedbackNegativeHelpful)
                    }
                    "BOT_FEEDBACK_NEGATIVE_INTERESTING" => {
                    ...
                    "BOT_FEEDBACK_NEGATIVE_REFUSED" => {
                        Some(Self::BotFeedbackNegativeRefused)
                    }
                    "BOT_FEEDBACK_NEGATIVE_NOT_VISUALLY_APPEALING" => {
    ...
    pub struct ImageMessage {
        ...
        pub scan_lengths: ::prost::alloc::vec::Vec<u32>,
        #[prost(bytes = "vec", optional, tag = "23")]
        pub mid_quality_file_sha256: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
        #[prost(bytes = "vec", optional, tag = "24")]
        pub mid_quality_file_enc_sha256: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
    ...
    pub struct InvoiceMessage {
        ...
        #[prost(bytes = "vec", optional, tag = "8")]
        pub attachment_file_enc_sha256: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
        #[prost(string, optional, tag = "9")]
        ...
        pub attachment_jpeg_thumbnail: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct Qp {}
/// Nested message and enum types in `QP`.
pub mod qp {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Filter {
        #[prost(string, required, tag = "1")]
        ...
        #[prost(message, repeated, tag = "2")]
        pub parameters: ::prost::alloc::vec::Vec<FilterParameters>,
        #[prost(enumeration = "FilterResult", optional, tag = "3")]
        pub filter_result: ::core::option::Option<i32>,
        #[prost(enumeration = "FilterClientNotSupportedConfig", required, tag = "4")]
        pub client_not_supported_config: i32,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct FilterClause {
        #[prost(enumeration = "ClauseType", required, tag = "1")]
        pub clause_type: i32,
        #[prost(message, repeated, tag = "2")]
    ...
    #[repr(i32)]
    pub enum FilterClientNotSupportedConfig {
        PassByDefault = 1,
        FailByDefault = 2,
    }
    impl FilterClientNotSupportedConfig {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        /// The values are not transformed in any way and thus are considered stable
        /// (if the ProtoBuf definition does not change) and safe for programmatic use.
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::PassByDefault => "PASS_BY_DEFAULT",
                Self::FailByDefault => "FAIL_BY_DEFAULT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "PASS_BY_DEFAULT" => Some(Self::PassByDefault),
                "FAIL_BY_DEFAULT" => Some(Self::FailByDefault),
                _ => None,
            }
        }
    }
...
pub mod session_structure {
    ...
    pub struct Chain {
        ...
        #[prost(bytes = "vec", optional, tag = "2")]
        pub sender_ratchet_key_private: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
        #[prost(message, optional, tag = "3")]
    ...
    pub struct PendingKeyExchange {
        ...
        #[prost(bytes = "vec", optional, tag = "5")]
        pub local_ratchet_key_private: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
        #[prost(bytes = "vec", optional, tag = "7")]
        pub local_identity_key: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
        #[prost(bytes = "vec", optional, tag = "8")]
        pub local_identity_key_private: ::core::option::Option<
            ::prost::alloc::vec::Vec<u8>,
        >,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SyncActionValue {
    ...
    #[prost(message, optional, tag = "6")]
    pub security_notification_setting: ::core::option::Option<
        sync_action_value::SecurityNotificationSetting,
    >,
    #[prost(message, optional, tag = "7")]
